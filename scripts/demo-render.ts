...
import { THEME_LIGHT, THEME_DARK } from "../src/worker/templates/themes.ts";
import type { DailyAgendaData, WeeklyOverviewData, EventCardData } from "../src/worker/templates/types.ts";
...
const dailyData: DailyAgendaData = {
  ...
  timedEvents: [
    { id: 2, title: "Morning standup", startMinutes: 9 * 60, endMinutes: 9 * 60 + 30, calendarColor: "#6366F1", isAllDay: false, location: "Zoom" },
    { id: 3, title: "Design review", startMinutes: 10 * 60, endMinutes: 11 * 60, calendarColor: "#14B8A6", isAllDay: false, location: "Room 42" },
    { id: 4, title: "1:1 with Alex", startMinutes: 10 * 60 + 30, endMinutes: 11 * 60 + 30, calendarColor: "#F59E0B", isAllDay: false },
    { id: 5, title: "Lunch with team", startMinutes: 12 * 60, endMinutes: 13 * 60, calendarColor: "#EF4444", isAllDay: false, location: "Cafe" },
  ],
  theme: THEME_LIGHT,
  locale: "en",
};
...
const weekData: WeeklyOverviewData = {
  ...
  days: [
    { dayNumber: 9, dayName: "Mon", eventCount: 3, isWeekend: false, events: [
    ...
    { dayNumber: 10, dayName: "Tue", eventCount: 1, isWeekend: false, events: [
      { title: "Product demo", startMinutes: 600, endMinutes: 720, color: "#F59E0B", isAllDay: false },
    ]},
    { dayNumber: 11, dayName: "Wed", eventCount: 4, isWeekend: false, events: [
      { title: "Standup", startMinutes: 540, endMinutes: 570, color: "#6366F1", isAllDay: false },
    ...
    { dayNumber: 12, dayName: "Thu", eventCount: 2, isWeekend: false, events: [
    ...
    { dayNumber: 14, dayName: "Sat", eventCount: 2, isWeekend: true, events: [
...
const cardData: EventCardData = {
  ...
  description: "Review the Q1 product roadmap, discuss priorities for the next sprint, and align on design system updates. Please bring your laptop with the latest Figma file open.",
