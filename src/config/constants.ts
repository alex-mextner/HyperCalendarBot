...
export const MSG = {
  en: {
    ...
    add_title_prompt: "📅 New event · 1/6\nWhat's the title?",
    add_time_prompt:
      '🕐 2/6 · When?\nExamples: “tomorrow 18:00”, “Mar 15 19:30”. If you send only a date, I’ll ask for the time next.',
    add_duration_prompt:
      '⏱ 3/6 · How long?\nExamples: “1h”, “30m”, “2h30m”. Or tap Skip for your default duration.',
    add_description_prompt: '📝 5/6 · Description? Send text, or tap Skip.',
    add_location_prompt: '📍 6/6 · Location? Send a place/address, or tap Skip.',
    ...
    recurrence_prompt: '🔁 4/6 · Repeat? Choose a button, or type a rule such as “every 2 weeks”.',
    recurrence_end_prompt: '🔁 Repeat until when? Choose a button, type a date, or type the number of repeats.',
    recurrence_custom_prompt: 'Type the recurrence rule, for example “every 2 weeks” or “daily”.',
    recurrence_until_prompt: 'Until what date? For example “Sep 26” or just “26”.',
    recurrence_count_prompt: 'How many times? For example: 5.',
    skip: 'Skip',
    ...
    settings: {
      ...
      voiceDesc1: 'When on — after you send a voice message, the bot also replies with a voice (TTS) copy.',
      voiceDesc2: 'Works in Russian and English depending on the bot language.',
      voiceDesc3: 'The text reply is still sent; voice is additional and can be disabled here anytime.',
  ...
  ru: {
    ...
    add_title_prompt: '📅 Новое событие · 1/6\nКак назовём?',
    add_time_prompt:
      '🕐 2/6 · Когда?\nНапример: «завтра 18:00», «25 сен 19:30». Если пришлёшь только дату, отдельно спрошу время.',
    add_duration_prompt:
      '⏱ 3/6 · Сколько длится?\nНапример: «1ч», «30м», «1ч30м». Или нажми «Пропустить» — возьму длительность по умолчанию.',
    add_description_prompt: '📝 5/6 · Описание? Пришли текст или нажми «Пропустить».',
    add_location_prompt: '📍 6/6 · Место? Пришли название/адрес или нажми «Пропустить».',
    ...
    recurrence_prompt: '🔁 4/6 · Повторять? Выбери кнопку или напиши правило, например «каждые 2 недели».',
    recurrence_end_prompt: '🔁 Когда закончить повторение? Можно выбрать кнопку, написать дату или число повторений.',
    recurrence_custom_prompt: 'Напиши правило повторения, например «каждые 2 недели» или «ежедневно».',
    recurrence_until_prompt: 'До какой даты? Например: «26 сен» или просто «26».',
    recurrence_count_prompt: 'Сколько повторений? Например: 5.',
    skip: 'Пропустить',
    ...
    settings: {
      ...
      voiceDesc1: 'Когда включено — после твоего голосового бот дополнительно отвечает голосом (TTS).',
      voiceDesc2: 'Работает на русском и английском в зависимости от языка бота.',
      voiceDesc3: 'Текстовый ответ остаётся; голос можно в любой момент отключить здесь.',
