...
export const MSG = {
  en: {
    ...
    connectTelegram: {
      ...
      codeSent: 'Verification code sent to Telegram.\nEnter the code with spaces or dashes (e.g. 1 2 3 4 5):',
      invalidCode: 'Invalid code. Enter 5 digits with spaces or dashes (e.g. 1 2 3 4 5).',
  ...
  ru: {
    ...
    connectTelegram: {
      ...
      codeSent: 'Код подтверждения отправлен в Telegram.\nВведи код через пробелы или дефисы (напр. 1 2 3 4 5):',
      invalidCode: 'Неверный код. Введи 5 цифр через пробелы или дефисы (напр. 1 2 3 4 5).',
