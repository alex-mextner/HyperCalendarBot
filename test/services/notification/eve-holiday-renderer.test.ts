...
describe('NotificationRenderer.renderEveHoliday', () => {
  ...
  test('falls back to English for unknown language', () => {
    ...
    expect(result.text).toContain('holiday tomorrow');
  });
});
